...
<div class="search-page ">
    ...
    {
    ?>
    <div class="search-page--tags bg-container"><?
        $arCloudParams = Array(
    ...
    <div class="search-page--form bg-container">
            ...
            <div class="col-xs-12">
                <div class="input-group">
                    ...
                    <? else: ?>
                        ...
                        <input class="search-query form-control" type="text" name="q"
                               value="<?= $arResult["REQUEST"]["QUERY"] ?>"/>
                ...
                <table class="search-filter" cellspacing="0">
                    ...
                    <tr>
                        ...
                        <td class="search-filter-field"><input class="search-button"
                                                               value="<? echo GetMessage("CT_BSP_GO") ?>" type="submit">
                        </td>
                    </tr>
                    </tbody>
                </table>
...
<div class="search-result bx-newslist row">
    <? if ($arResult["REQUEST"]["QUERY"] === false && $arResult["REQUEST"]["TAGS"] === false): ?>
    <? elseif ($arResult["ERROR_CODE"] != 0): ?>
    <div class="col-xs-12 bg-container">
    ...
    <? foreach ($arResult["SEARCH"] as $arItem): ?>
        <div class="search-item bx-newslist-container col-sm-12 col-md-12  bg-container">
            <h4><a href="<? echo $arItem["URL"] ?>" target="_blank"><? echo $arItem["TITLE_FORMATED"] ?></a></h4>
            <?
            //Подключаем картинку
            ...
            <? if (
                ...
                <div class="search-item-meta">
                    ...
                    <? if ($arParams["SHOW_ITEM_TAGS"] != "N" && !empty($arItem["TAGS"])): ?>
                        <div class="search-item-tags bx-newslist-tags"><i class="fa fa-tag"></i>
                            <?
