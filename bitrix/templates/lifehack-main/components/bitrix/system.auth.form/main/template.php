    ...
    <? if ($arResult["FORM_TYPE"] == "login"): ?>
        ...
        <form name="system_auth_form<?= $arResult["RND"] ?>" method="post" target="_top" class="form-horizontal"
            ...
            <table width="95%">
                ...
                <? endif ?>
                <tr>
                    <td colspan="2"><input type="submit" class="btn btn-primary btn-xs" style="width: 100%; margin-top: 5px" name="Login" value="<?= GetMessage("AUTH_LOGIN_BUTTON") ?>"/>
                    </td>
                </tr>
                <?
                    ...
                    <tr>
                        <td colspan="2">
                            <noindex><a href="<?= $arResult["AUTH_REGISTER_URL"] ?>"
                                        rel="nofollow" class="btn btn-link btn-xs"><?= GetMessage("AUTH_REGISTER") ?></a></noindex>
                            <br/></td>
                    </tr>
                <? endif ?>
                ...
                <tr>
                    <td colspan="2">
                        <noindex><a href="<?= $arResult["AUTH_FORGOT_PASSWORD_URL"] ?>"
                                    rel="nofollow" class="btn btn-link btn-xs"><?= GetMessage("AUTH_FORGOT_PASSWORD_2") ?></a></noindex>
                    </td>
                </tr>
                <?
