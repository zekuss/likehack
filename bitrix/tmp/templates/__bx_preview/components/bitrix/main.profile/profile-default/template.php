...
<input class="form-control" type="hidden" name="ID" value=<?=$arResult["ID"]?> />
...
<table class="data-table profile-table">
	...
	<tbody>
		...
		<tr>
			...
			<td><input class="form-control" type="text" name="PERSONAL_PHONE" maxlength="255" value="<?=$arResult["arUser"]["PERSONAL_PHONE"]?>" /></td>
		</tr>
		<tr>
			<td><?=GetMessage('USER_FAX')?></td>
			<td><input class="form-control" type="text" name="PERSONAL_FAX" maxlength="255" value="<?=$arResult["arUser"]["PERSONAL_FAX"]?>" /></td>
		</tr>
		<tr>
			<td><?=GetMessage('USER_MOBILE')?></td>
			<td><input class="form-control" type="text" name="PERSONAL_MOBILE" maxlength="255" value="<?=$arResult["arUser"]["PERSONAL_MOBILE"]?>" /></td>
		</tr>
		<tr>
...
<table class="data-table profile-table">
	...
	<tbody>
		<tr>
			...
			<td><input class="form-control" type="hidden" name="forum_SHOW_NAME" value="N" /><input class="form-control" type="checkbox" name="forum_SHOW_NAME" value="Y" <?if ($arResult["arForumUser"]["SHOW_NAME"]=="Y") echo "checked=\"checked\"";?> /></td>
		</tr>
		<tr>
...
<table class="data-table profile-table">
	...
	<table class="data-table profile-table">
		...
		<tbody>
			<tr>
				...
				<td><input class="form-control" type="hidden" name="student_PUBLIC_PROFILE" value="N" /><input class="form-control" type="checkbox" name="student_PUBLIC_PROFILE" value="Y" <?if ($arResult["arStudent"]["PUBLIC_PROFILE"]=="Y") echo "checked=\"checked\"";?> /></td>
			</tr>
			<tr>
	...
	<p><input class="btn btn-primary " type="submit" name="save" value="<?=(($arResult["ID"]>0) ? GetMessage("MAIN_SAVE") : GetMessage("MAIN_ADD"))?>">&nbsp;&nbsp;<input class=" btn btn-link" type="reset" value="<?=GetMessage('MAIN_RESET');?>"></p>
</form>
<?
