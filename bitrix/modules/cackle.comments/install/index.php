...
Class cackle_comments extends CModule
{
    ...
    function __construct()
    {
        ...
        $this->MODULE_NAME = GetMessage('CACKLE_PLATFORM_MODULE_NAME');
        $this->MODULE_DESCRIPTION = GetMessage('CACKLE_PLATFORM_MODULE_DESCRIPTION');
    }
//
    function InstallDB()
    {
    ...
    function DoUninstall(){
        ...
        UnRegisterModule("$this->MODULE_ID");
         //       $APPLICATION->IncludeAdminFile(GetMessage("CACKLE_PLATFORM_UNINSTALL_TITLE"), $_SERVER["DOCUMENT_ROOT"]."/bitrix/modules/cackle/install/unstep.php");
